...
@section('body')
            ...
            <div class="col-lg-8">
              ...
              <div class="info-branding">
                ...
                <div class="providers">
                  ...
                  <div class="item">
                    <a href="#">
                      <img src="styling/images/providers/provider-1.png" alt="Image">
                    </a>
                  </div>
                  <!-- ITEM -->
                  <div class="item">
                    <a href="#">
                      <img src="styling/images/providers/provider-2.png" alt="Image">
                    </a>
                  </div>
                  <!-- ITEM -->
                  <div class="item">
                    <a href="#">
                      <img src="styling/images/providers/provider-3.png" alt="Image">
                    </a>
                  </div>
                  <!-- ITEM -->
                  <div class="item">
                    <a href="#">
                      <img src="styling/images/providers/provider-4.png" alt="Image">
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="room.html">
                    <img src="styling/images/rooms/single/single1.jpg" class="img-fluid" alt="Image">
                  </a>
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="room.html">
                    <img src="styling/images/rooms/double/double.jpg" class="img-fluid" alt="Image">
                  </a>
                  <div class="room-services">
                    <i class="fa fa-coffee" aria-hidden="true" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Breakfast Included" data-original-title="Breakfast"></i>
                    <i class="fa fa-wifi" aria-hidden="true" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Free WiFi" data-original-title="WiFi"></i>
            ...
            <div class="col-md-4">
              <div class="room-grid-item">
                <figure class="gradient-overlay-hover link-icon">
                  <a href="room.html">
                    <img src="styling/images/rooms/deluxe/deluxe.jpg" class="img-fluid" alt="Image">
                  </a>
                  <div class="room-services">
                    <i class="fa fa-coffee" aria-hidden="true" data-toggle="popover" data-placement="right" data-trigger="hover" data-content="Breakfast Included" data-original-title="Breakfast"></i>
            ...
            <div class="col-lg-7 col-12">
              <div data-slider-id="services" class="services-owl owl-carousel">
                <figure class="gradient-overlay">
                  <img src="styling/images/services/restaurant.jpg" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Restaurant</h4>
                  </figcaption>
                </figure>
                <figure class="gradient-overlay">
                  <img src="styling/images/services/spa.jpg" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Spa</h4>
                  </figcaption>
                </figure>
                <figure class="gradient-overlay">
                  <img src="styling/images/services/conference.jpg" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Conference Room</h4>
                  </figcaption>
                </figure>
                <figure class="gradient-overlay">
                  <img src="styling/images/services/swimming.jpg" class="img-fluid" alt="Image">
                  <figcaption>
                    <h4>Swimming Pool</h4>
                  </figcaption>
                </figure>
        ...
        <div class="container">
          ...
          <div class="owl-carousel testimonials-owl">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="styling/images/users/user1.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="styling/images/users/user2.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="styling/images/users/user3.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="styling/images/users/user4.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="styling/images/users/user5.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="styling/images/users/user6.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="styling/images/users/user7.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="styling/images/users/user8.jpg">
                </div>
                <div class="author">
            ...
            <div class="item">
              <div class="testimonial-item">
                <div class="author-img">
                  <img alt="Image" class="img-fluid" src="styling/images/users/user9.jpg">
                </div>
                <div class="author">
              ...
              <div class="restaurant-menu-item">
                <div class="row">
                  <div class="col-lg-4 col-12">
                    <figure>
                      <img src="styling/images/restaurant/restaurant1.jpg" class="img-fluid " alt="Image">
                    </figure>
                  </div>
            ...
            <div class="col-md-6 col-sm-6 col-6">
              <div class="restaurant-menu-item">
                <div class="row">
                  <div class="col-lg-4 col-12">
                    <figure>
                      <img src="styling/images/restaurant/restaurant2.jpg" class="img-fluid" alt="Image">
                    </figure>
                  </div>
                  <div class="col-lg-8 col-12">
                    <div class="info">
            ...
            <div class="col-md-4">
              <div class="news-grid-item">
                ...
                <div class="news-info">
                  ...
                  <div class="post-meta">
                    <span class="author">
                      <a href="#"><img src="styling/images/users/admin.jpg" width="16" alt="Image">
                        JANE</a>
                    </span>
                    <span class="date">
      ...
      <!-- ========== VIDEO ========== -->
      <section class="video np parallax gradient-overlay op6" data-src="styling/images/video.jpg" data-parallax="scroll" data-speed="0.3" data-mirror-selector=".wrapper" data-z-index="0">
